...
const customerSchema = new mongoose.Schema(
  {
    ...
    firstName: {
        ...
        maxLength: [10, 'A customer full name must be of length equal to or less than 30 characters'],
        minLength: [0, 'A customer name must be greater than 0 characters'],
        trim: true
    },
    middleName: {
        type: String,
        maxLength: [10, 'A customer middle name must be of length equal to or less than 30 characters'],
        minLength: [0, 'A customer name must be greater than 0 characters'],
        trim: true
    },
    lastName: {
        type: String,
        maxLength: [10, 'A customer full name must be of length equal to or less than 90 characters'],
        minLength: [0, 'A customer name must be greater than 0 characters'],
        trim: true
    },
    dateOfBirth: {
